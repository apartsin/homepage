    ...
    primaryNav: [
      ...
      link(
        ...
        [
          ...
          /\/research\/sparse-multi-agent-ai\.html$/i,
          /\/research\/optimization-and-ai\.html$/i,
          /\/research\/robust-language-ai\.html$/i,
          /\/research\/robust-vision-ai\.html$/i,
          /\/research\/robust-signal-ai\.html$/i,
          /\/research\/pragmatic-ai-lab\.html$/i,
            ...
            secondary: [
              {
                ...
                secondary: [
                  { label: 'Robust Language AI', path: 'research/robust-language-ai.html' },
                  { label: 'Robust Vision AI', path: 'research/robust-vision-ai.html' },
                  { label: 'Robust Signal AI', path: 'research/robust-signal-ai.html' },
                ],
              },
              ...
              { label: 'Optimization and AI', path: 'research/optimization-and-ai.html' },
