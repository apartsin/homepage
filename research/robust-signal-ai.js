/* robust-signal-ai.js
   Unified, filterable view for the "Robust Signal AI" theme. Pulls from the
   ...
   grid, keeps only Signals-modality items, and filters via Application / Type /
...
(function () {
  ...
  var AUTO = "Automotive & Mobility",
      ...
      PDM = "Predictive Maintenance and Monitoring",
  ...
  var INDUSTRY_APP = {
    "Questar Automotive": PDM, "Motorola Solutions": SAFETY, "Smartlight": MED,
  ...
  var INDUSTRY_APP_TITLE = {
    ...
    "Distributed Billing System Load Modeling": PDM
  };
  var INDUSTRY_DESC = {
  ...
  [
    ...
    { name: "Ben Kedarya & Yael Rikka", degree: "B.Sc.", app: REMOTE, year: 2024, data: SIGNALS, title: "Audio Alarm Detection",
  ...
  /* ---------- keep only the Signals modality (this is the signal page) ---------- */
  items = items.filter(function (it) { return it.data === "Signals"; });
