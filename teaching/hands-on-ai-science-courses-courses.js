(function () {
  ...
  cards.forEach((card) => {
    ...
    if (card.bookLink) {
      ...
      bookBadge.innerHTML = '<svg viewBox="0 0 24 24" aria-hidden="true"><path d="M18 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V4a2 2 0 0 0-2-2zM6 4h5v8l-2.5-1.5L6 12V4z"/></svg><span>Companion Textbook</span>';
